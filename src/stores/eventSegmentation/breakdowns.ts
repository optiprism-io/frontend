...
export const newBreakdownCohort = (cohortId?: number) => <BreakdownCohort>{
    type: 'Cohort',
    cohortId: cohortId,
}

export const newBreakdownUserProperty = (propertyId: number) => <BreakdownUserProperty>{
    type: 'UserProperty',
    propertyId: propertyId
}
export const newBreakdownUserCustomProperty = (propertyId: number) => <BreakdownUserCustomProperty>{
    type: 'UserCustomProperty',
    propertyId: propertyId
}


export const newBreakdownEventCommonProperty = (propertyId: number) => <BreakdownEventCommonProperty>{
    type: 'EventCommonProperty',
    propertyId: propertyId
}

export const newBreakdownEventCommonCustomProperty = (propertyId: number) => <BreakdownEventCommonCustomProperty>{
    type: 'EventCommonCustomProperty',
    propertyId: propertyId
}

export const isBreakdownUserProperty = (breakdown: Breakdown) => breakdown.type === 'UserProperty'
export const isBreakdownUserCustomProperty = (breakdown: Breakdown) => breakdown.type === 'UserCustomProperty'
export const isBreakdownEventCommonProperty = (breakdown: Breakdown) => breakdown.type === 'EventCommonProperty'
export const isBreakdownEventCommonCustomProperty = (breakdown: Breakdown) => breakdown.type === 'EventCommonCustomProperty'
export const isBreakdownEventProperty = (breakdown: Breakdown) => breakdown.type === 'EventEventProperty'
export const isBreakdownEventCustomProperty = (breakdown: Breakdown) => breakdown.type === 'EventCustomProperty'
