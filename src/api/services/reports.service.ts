...
const schemaReports = {
    eventSegmentation: async(organizationId: number, projectId: number, eventSegmentation: EventSegmentation) => await queryApi.eventSegmentationQuery(organizationId, projectId, EventSegmentationQueryFormatEnum.Json, eventSegmentation),
